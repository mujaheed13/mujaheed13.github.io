...
const Hero = () => {
  return (
    ...
    >
      ...
      <div
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-conic from-blue-500/20 via-purple-500/20 to-blue-500/20 rounded-full blur-3xl animate-spin"
