          ...
          <div className="animate-fade-in">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">mrmujaheed13@gmail.com</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+91 7993688315</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a
                  href="https://www.linkedin.com/in/mohammad-mujaheed-a86801218/"
                  target="_blank"
                ...
                <a
                  href="https://github.com/mujaheed13/"
                  target="_blank"
